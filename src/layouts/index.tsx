    ...
    <Layout>
      ...
      <Content style={{ padding: '0 3%' }}>
        <div style={{ marginTop: 54, padding: 24, minHeight: 280 }}>
          {cloneElement(children, { currency: currency, setLastModified: setLastModified })}
        </div>
      </Content>
      <Footer style={{ textAlign: 'center' }}>
        <Typography>
          ...
          <Typography.Paragraph>
            感谢
            &nbsp;
            <Typography.Link href="https://bbs.nga.cn/nuke.php?func=ucp&uid=60146242">山桜</Typography.Link>
            &nbsp;
            <Typography.Link href="https://bbs.nga.cn/nuke.php?func=ucp&uid=37746312">根派</Typography.Link>
          </Typography.Paragraph>
          <Typography.Paragraph>
            Copyright © hguandl 2021.
          </Typography.Paragraph>
        </Typography>
      </Footer>
    </Layout>
